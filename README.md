...
- `90-100`: mostly stable posture with low immediate drift/risk.
- `70-89`: moderate warnings; prioritize high-weight findings.
- `0-69`: significant warning/critical pressure requiring remediation.
